...
class HandsExtractor:
    ...
    def extract_points(self, face_image: np.ndarray, hands_info: Any, hand_index: int = 0) -> List[List[int]]:
        ...
        finger_points ={
            "thumb" : hands_points[4][1:], #pulgar
            "index_finger" : hands_points[8][1:], #indice
            "middle_finger" : hands_points[12][1:], #medio
            "ring_finger" : hands_points[16][1:], #anular
            "little_finger" : hands_points[20][1:] #meñique
        }
        return hands_points
