...
from procesar_fatiga.extraer_puntos.face_mesh.face_mesh_processor import FaceMeshProcessor
from procesar_fatiga.extraer_puntos.hands.hands_processor import HandsProcessor
