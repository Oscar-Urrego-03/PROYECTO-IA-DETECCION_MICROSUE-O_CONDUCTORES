...
class FlickerReportGenerator(ReportGenerator):
    def generate_report(self, data: dict[str, bool | int | list]) -> Dict[str, Any]:
        ...
        return {
            ...
            'report_message': f'Counting flickers... {2 - elapsed_time} seconds remaining.',
...
class FlickerEstimator(DrowsinessProcessor):
    def __init__(self):
        ...
        self.tts_engine.setProperty('volume', 2.0)

    def alert_driver(self):
        self.tts_engine.say("Despierta conductor"
    ...
    def process(self, eyes_distance: dict):
        ...
        return {
            'flicker_count': f'Counting flickers... {2 - elapsed_time} seconds remaining.',
            'flicker_report': False,
            'micro_sleep_report': False
        }
